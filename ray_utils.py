...
def get_random_pixels_from_image(n_pixels, image_size, camera):
    ...
    W,H = image_size[0], image_size[1]
    random_pixels = torch.randint(0, W * H, (n_pixels,))
    xy_grid_sub = xy_grid[random_pixels, :]

    # print("Shape before return: ", xy_grid_sub.shape)

    # Return
    # print("Shape while return: " , xy_grid_sub.reshape(-1, 2)[:n_pixels].shape)
